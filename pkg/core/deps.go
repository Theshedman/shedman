...
type DependencyTree struct {
	db          PackageDB
	installedDB PackageDB // For checking installed packages
...
func NewDependencyTree(db PackageDB) *DependencyTree {
...
func NewDependencyTreeWithOptions(db, installedDB PackageDB, opts DependencyTreeOptions) *DependencyTree {
...
func (dt *DependencyTree) GetNewPackages() []PackageInfo {
