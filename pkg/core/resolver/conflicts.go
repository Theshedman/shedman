...
type ConflictDetector struct {
	db          pkgdb.PackageDB
	installedDB pkgdb.PackageDB // For checking conflicts with installed packages
}
...
func NewConflictDetectorWithInstalled(db, installedDB pkgdb.PackageDB) *ConflictDetector {
...
func (cd *ConflictDetector) detectConflicts(packages []string, installedPackages []string) []Conflict {
	...
	installedInfos := make(map[string]*pkgdb.PackageInfo)
