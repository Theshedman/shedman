...
func GetPackageFilesWithBackend(b OfficialBackend, packageName string) ([]string, error) {
	if b == nil {
		return nil, nil
	}
...
func GetInstalledPackageFilesWithBackend(b OfficialBackend) (map[string][]string, error) {
